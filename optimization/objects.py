from models import Manufacturer, Shop, Warehouse
from utils import Vegetable
from utils import weekly_demand_bounds
...
def get_shops():
    ...
    # In case we change the demand bounds, they're dynamically generated
    average_weekly_demand = mean(
...
def get_warehouses():
    ...
    return [
        Warehouse((52.175584628053144, 20.793660692851642), "Pruszków", 800),
        Warehouse((52.095790995772646, 21.023008661957697), "Piaseczno", 1200),
        Warehouse((52.289563668216005, 21.235200160810102), "Zielonka", 750),
    ]
